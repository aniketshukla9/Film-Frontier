  ...
  return info?(
    <div
     style={{
      ...
      className='relative  w-screen text-zinc-100 h-[200vh] px-[10%] '>
          {/* part 1 navigation */}
        ...
        <img className='h-[60vh] shadow-[8px_17px_38px_2px_rgba(0,0,0,0.5)]' src={`https://image.tmdb.org/t/p/original/${
          ...
          <h1 className='text-2xl mt-5 mb-3  text-zinc-300'> Movie Translated
          </h1> 
        ...
        <div>
          ...
          {/* part 4 recomendation and similar stuff */}
