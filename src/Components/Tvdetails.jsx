  ...
  return info ? (
    ...
    >
      ...
      <div className="w-full flex">
        <img
          className="h-[60vh] shadow-[8px_17px_38px_2px_rgba(0,0,0,0.5)]"
        ...
        <div className=" mr-10 ml-[5%]">
          ...
          <h1 className="text-xl mt-5 font-semibold italic text-zinc-200">
            {info.detail.tagline}
          </h1>

          <h1 className="text-2xl mt-5 mb-3  text-zinc-300">Overview</h1>
          <p>{info.detail.overview} </p>
          <h1 className="text-2xl mt-5 mb-3  text-zinc-300"> TV Translated</h1>
          <p className="mb-10">{info.translations.join(", ")} </p>

          <Link
            className="shadow-xl font-semibold p-4 bg-[#5A2086] rounded"
            to={`${pathname}/trailer`}
          >
